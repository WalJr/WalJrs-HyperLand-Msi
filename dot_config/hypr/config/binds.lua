...
-- Move active window to workspace (follows) / silent move (stay put)
for i = 1, NUM_WPM do
    local key = i % 10
...
-- Vicinae app selector
hl.bind("ALT + Space",              hl.dsp.exec_cmd("vicinae vicinae://toggle"))
...
hl.bind(mainMod .. " + ALT + T", hl.dsp.exec_cmd("/home/waljr/.config/hypr/scripts/touchpad-toggle.sh"), { locked = true })
hl.bind("XF86TouchpadToggle",    hl.dsp.exec_cmd("/home/waljr/.config/hypr/scripts/touchpad-toggle.sh"), { locked = true })
...
-- Focus on monitors
hl.bind(mainMod .. " + ALT + F1", hl.dsp.focus({ monitor = MONITOR1 }))
hl.bind(mainMod .. " + ALT + F2", hl.dsp.focus({ monitor = MONITOR2 }))
hl.bind(mainMod .. " + ALT + F3", hl.dsp.focus({ monitor = MONITOR3 }))

-- Toggle laptop screen (game mode)
hl.bind(mainMod .. " + ALT + M", hl.dsp.exec_cmd("/home/waljr/.config/hypr/scripts/toggle-internal-monitor.py"))

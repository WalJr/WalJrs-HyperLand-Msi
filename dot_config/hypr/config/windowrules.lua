...
hl.window_rule({ match = { class = terminals }, opacity = "1.0" }) -- Multiplier only, so terminals can control their own background opacity. Add "override" only if you want to force them opaque.
